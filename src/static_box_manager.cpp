...
static_box_manager::static_box_manager(const static_box_config& cfg)
        : cfg_(cfg) {}

void static_box_manager::on_mouse_click(
        int x, int y,
...
void static_box_manager::update(
        const std::vector<cv::Rect2f>& boxes,
        const std::vector<int>& ids
) {
...
int static_box_manager::find_best_match(
        const static_box& sb,
        const std::vector<cv::Rect2f>& boxes,
...
int static_box_manager::find_nearest(
        const static_box& sb,
        const std::vector<cv::Rect2f>& boxes
) const {
